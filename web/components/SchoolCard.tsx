...
export default function SchoolCard({ school }: SchoolCardProps) {
  return (
    <div className="bg-card rounded-xl border border-border shadow-sm hover:shadow-md transition-shadow overflow-hidden">
      ...
      <div className="h-36 bg-gradient-to-br from-pilgrim-orange/18 via-paper-depth to-paper flex items-center justify-center">
      ...
      <div className="p-4">
        ...
        <div className="flex gap-2 mt-3">
          ...
          <Link
            ...
            className="flex-1 text-center text-xs font-medium rounded-lg bg-primary px-3 py-1.5 text-primary-foreground shadow-[0_10px_24px_rgba(255,109,35,0.22)] transition-colors hover:bg-pilgrim-orange-deep"
          >
            Support
          </Link>
        </div>
